...
const Billing = () => (
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        Create Customize and Print compliant bills and invoices within a few seconds. A business management software which is the perfect partner for your hustle! Free Demo. 
